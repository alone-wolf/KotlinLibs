...
fun HSSFSheet.mergeCells(startRow: Int, startColumn: Int, endRow: Int, endColumn: Int) {
    addMergedRegion(CellRangeAddress(startRow, endRow, startColumn, endColumn))
}

fun HSSFSheet.mergeCells(range: CellRangeAddress) {
    addMergedRegion(range)
}

fun HSSFSheet.copyFrom(sourceSheet: HSSFSheet) {
