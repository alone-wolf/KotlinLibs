package top.writerpass.jiebajvm.viterbi

import top.writerpass.jiebajvm.CharacterUtil
import top.writerpass.jiebajvm.Node
import top.writerpass.jiebajvm.Pair
...
class FinalSeg internal constructor() {
    ...
    private fun loadModel() {
        ...
        val assetInputStream = getInputStream(PROB_EMIT)
    ...
    companion object {
        ...
        suspend fun getInstance(): FinalSeg {
            return withContextIO {
                FinalSeg().apply { loadModel() }
            }
        }
